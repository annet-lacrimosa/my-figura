...
function initDateInput() {
    jQuery('.date-input').datetextentry({
        field_order : 'MDY',
        show_tooltips : false,
        min_date: '1915-01-01',
        max_date: '9999-31-12',
        min_date_message: 'Please select a date in range from 1915 to 1999',
        max_date_message: 'Please select a date in range from 1915 to 1999',
        E_DAY_NAN: 'Must be a number',
        E_MONTH_NAN: 'Must be a number',
        E_YEAR_NAN: 'Must be a number',
        E_BAD_DAY_FOR_MONTH: 'Must be a valid date',
        E_DAY_TOO_BIG: 'Must be a valid date',
        E_DAY_TOO_SMALL: 'Must be a valid date',
        E_MONTH_TOO_BIG: 'Must be a valid date',
        E_MONTH_TOO_SMALL: 'Must be a valid date',
        E_YEAR_LENGTH: 'Must be a valid date',
        E_YEAR_TOO_BIG: 'Please select a date in range from 1915 to 1999',
        E_YEAR_TOO_SMALL: 'Please select a date in range from 1915 to 1999',
        E_MAX_DATE: 'Please select a date in range from 1915 to 1999',
        E_MIN_DATE: 'Please select a date in range from 1915 to 1999',
    });
}
/*
...
(function ($) {
    ...
    DateTextEntry.prototype = {
        ...
        build_ui: function () {
            ...
            this.wrapper.append(this.inner, this.tooltip,);
            this.wrapper.prepend(this.errorbox);
